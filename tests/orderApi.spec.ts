...
test('Positive: Update order with valid id = 1 + valid api_key | 200 OK', async ({ request }) => {
  const body = { status: 'OPEN', courierId: 0, customerName: 'string', customerPhone: 'string', comment: 'string', id: 1 };
...
test('Positive: Update order with valid id = 2 + valid api_key | 200 OK', async ({ request }) => {
  const body = { status: 'OPEN', courierId: 0, customerName: 'string', customerPhone: 'string', comment: 'string', id: 2 };
  const headers = { api_key: validApiKey };
...
test('Positive: Update order with valid id = 3 + valid api_key | 200 OK', async ({ request }) => {
  const body = { status: 'OPEN', courierId: 0, customerName: 'string', customerPhone: 'string', comment: 'string', id: 3 };
  const headers = { api_key: validApiKey };
...
test('Negative: Update order with invalid api_key = 123 | 401 Unauthorized', async ({ request }) => {
  const body = { status: 'OPEN', courierId: 0, customerName: 'string', customerPhone: 'string', comment: 'string', id: 1 };
...
test('Negative: Update order with invalid api_key = 123456789012345a | 401 Unauthorized', async ({ request }) => {
  const body = { status: 'OPEN', courierId: 0, customerName: 'string', customerPhone: 'string', comment: 'string', id: 1 };
...
test('Negative: Update order with invalid "id": a | 400 Bad Request', async ({ request }) => {
  const body = { status: 'OPEN', courierId: 0, customerName: 'string', customerPhone: 'string', comment: 'string', id: 'a' };
  const headers = { api_key: validApiKey };
...
test('Negative: Delete order with invalid api_key = 123 | 401 Unauthorized', async ({ request }) => {
  const headers = { api_key: '123' };
...
test('Negative: Delete order with invalid api_key = 123456789012345b | 401 Unauthorized', async ({ request }) => {
...
test('Positive: Get order with valid username: username1, password: Password123 | 200 OK', async ({ request }) => {
...
test('Positive: Get order with valid username: username2, password: Hello123 | 200 OK', async ({ request }) => {
...
test('Positive: Get order with valid username: username3, password: Welcome01 | 200 OK', async ({ request }) => {
...
test('Negative: Get order with valid username: username4, missing password | 500 Undocumented', async ({ request }) => {
...
test('Negative: Get order with empty username and password | 500 Undocumented', async ({ request }) => {
...
test('Negative: Get order with empty username, valid password: Valid123 | 500 Undocumented', async ({ request }) => {
